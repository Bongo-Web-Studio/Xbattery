...
export default function FooterCarAnimationComponentMobile() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={groupRef}
        className="pointer-events-none select-none mt-[1.5cm] relative"
      >
        {/* Car image */}
        <img
          ref={carRef}
          className="w-[100vw]   h-[60vh] object-right object-cover"
          src="./footercar.png"
          alt="moving car"
          draggable="false"
        />
        ...
        <img
          ...
          className="absolute bottom-[3.5cm] left-[4.5cm] w-[3.5cm]"
          src="./cartyre.png"
          alt="front tyre"
          draggable="false"
        />
